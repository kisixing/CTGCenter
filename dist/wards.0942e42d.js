  ...
  constructor(params) {
    ...
    this.deleteWard = record => {
      lib["request"].delete("/wards/".concat(record.id)).then(res => {
        ...
        message["a" /* default */].error("\u75C5\u533A".concat(record.wardName, "\u5220\u9664\u5931\u8D25\uFF0C\u53EF\u80FD\u6709\u7528\u6237\u5DF2\u7ECF\u7ED1\u5B9A\u8BE5\u75C5\u533A\u3002\u5982\u9700\u5220\u9664\u8BF7\u5148\u786E\u4FDD\u8BE5\u75C5\u533A\u65E0\u7528\u6237\u7ED1\u5B9A\u3002"));
      });
    };
    ...
    this.fetcBeds = () => {
      lib["request"].get('/bedinfos').then(res => {
        this.setState({
          bedinfos: res
        });
      });
    ...
    this.noToName = value => {
      ...
      var _loop = function _loop(i) {
        var no = noArr[i];
        var element = beds.filter(e => e.deviceno === no)[0];
