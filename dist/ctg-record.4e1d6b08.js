...
// extracted by mini-css-extract-plugin
module.exports = {"wrapper":"wrapper___2YrFJ"};
...
var antd = __webpack_require__("./node_modules/antd/dist/antd.css");
...
class Header_Header extends react["Component"] {
  constructor() {
    super(...arguments);
    this[0] = void 0;
...
class Content_Content extends react["Component"] {
  constructor(props) {
    ...
    this.fetch = docId => {
      ...
      setTimeout(() => {
        utils_request.get("/ctg-exams-data/".concat(docId)).then(function (response) {
          console.log(response);
          var data = response.data;
          var ctgData = transformsCTG(data.docid, response.data); // {}
