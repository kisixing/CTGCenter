...
class App_App extends react["Component"] {
  constructor(props) {
    ...
    this.fetchList = () => {
      ...
      var params = Object(qs_lib["parse"])(url_params);
      var paramsStr = Object(qs_lib["stringify"])(params);
      request["a" /* default */].get("/prenatal-visits-encrypt?".concat(paramsStr)).then(function (response) {
        // handle success
        var dataSource = response.data;
